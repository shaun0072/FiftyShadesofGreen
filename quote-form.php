			...
			<div class="nav-inner-cont">
				...
				<div class="contact-cont">
					...
					<ul class="submenu contact-submenu">
						...
						<li><a href="mailto:erin@FiftyShadesofGreenok.com">Email: erin@FiftyShadesofGreenok.com</a></li>
					</ul>
				</div>
			</div>
		</nav>
			...
			<div class="header_and_nav">
				...
				<header>
					...
					<div class="contact_info">
						<a href="tel:9186054763"><span class="type">Landscape: </span><span class="phoNum">(918)605-4763</span></a>
					</div>
				</header>
			...
			<footer class="footer_section">
				...
				<div class="homepg_contact">
					...
					<div class="mail">
						...
						<a href="mailto:erin@FiftyShadesofGreenok.com">erin@FiftyShadesofGreenok.com</a>
					</div>
				</div>
				<hr />
